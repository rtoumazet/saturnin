...
void m68k_op_1010(void) { m68ki_exception_1010(); }

void m68k_op_1111(void) { m68ki_exception_1111(); }
...
void m68k_op_andi_16_toc(void) { m68ki_set_ccr(m68ki_get_ccr() & OPER_I_16()); }
...
void m68k_op_bfchg_32_d(void) {
    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
        ...
        if (BIT_B(word2)) offset = REG_D[offset & 7];
        if (BIT_5(word2)) width = REG_D[width & 7];
...
void m68k_op_bfchg_32_ai(void) {
    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
        ...
        if (BIT_B(word2)) offset = MAKE_INT_32(REG_D[offset & 7]);
        if (BIT_5(word2)) width = REG_D[width & 7];
...
void m68k_op_bfexts_32_ai(void) {
    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
        ...
        if ((offset + width) > 32) data |= (m68ki_read_8(ea + 4) << offset) >> 8;
...
void m68k_op_bfffo_32_ai(void) {
    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
        ...
        if ((local_offset + width) > 32) data |= (m68ki_read_8(ea + 4) << local_offset) >> 8;
...
void m68k_op_btst_8_r_ai(void) { FLAG_Z = OPER_AY_AI_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_pi(void) { FLAG_Z = OPER_AY_PI_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_pi7(void) { FLAG_Z = OPER_A7_PI_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_pd(void) { FLAG_Z = OPER_AY_PD_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_pd7(void) { FLAG_Z = OPER_A7_PD_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_di(void) { FLAG_Z = OPER_AY_DI_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_ix(void) { FLAG_Z = OPER_AY_IX_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_aw(void) { FLAG_Z = OPER_AW_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_al(void) { FLAG_Z = OPER_AL_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_pcdi(void) { FLAG_Z = OPER_PCDI_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_pcix(void) { FLAG_Z = OPER_PCIX_8() & (1 << (DX & 7)); }

void m68k_op_btst_8_r_i(void) { FLAG_Z = OPER_I_8() & (1 << (DX & 7)); }

void m68k_op_btst_32_s_d(void) { FLAG_Z = DY & (1 << (OPER_I_8() & 0x1f)); }
...
void m68k_op_chk2cmp2_8_ai(void) {
    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
        ...
        if (!BIT_F(word2)) compare = MAKE_INT_8(compare);

        FLAG_C = compare - lower_bound;
        FLAG_Z = MASK_OUT_ABOVE_8(FLAG_C);
        if (COND_CS()) {
            if (BIT_B(word2)) m68ki_exception_trap(EXCEPTION_CHK);
            return;
        }

        FLAG_C = upper_bound - compare;
        FLAG_Z = MASK_OUT_ABOVE_8(FLAG_C);
        if (COND_CS() && BIT_B(word2)) m68ki_exception_trap(EXCEPTION_CHK);
...
void m68k_op_chk2cmp2_16_ai(void) {
    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
        ...
        if (!BIT_F(word2)) compare = MAKE_INT_16(compare);
