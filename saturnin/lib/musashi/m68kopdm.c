...
void m68k_op_dbt_16(void) { REG_PC += 2; }
        ...
        if (divisor != 0) {
            ...
            if (BIT_A(word2)) {
                ...
                if (BIT_B(word2)) /* signed */
                {
                    ...
                    if (divisor_neg) quotient = (uint)MASK_OUT_ABOVE_32(-(sint)quotient);
                }
...
void m68k_op_eori_16_toc(void) { m68ki_set_ccr(m68ki_get_ccr() ^ OPER_I_16()); }
...
void m68k_op_illegal(void) { m68ki_exception_illegal(); }

void m68k_op_jmp_32_ai(void) {
    m68ki_jump(EA_AY_AI_32());
    m68ki_trace_t0(); /* auto-disable (see m68kcpu.h) */
    if (REG_PC == REG_PPC) USE_ALL_CYCLES();
}
...
void m68k_op_lea_32_ai(void) { AX = EA_AY_AI_32(); }

void m68k_op_lea_32_di(void) { AX = EA_AY_DI_32(); }

void m68k_op_lea_32_ix(void) { AX = EA_AY_IX_32(); }

void m68k_op_lea_32_aw(void) { AX = EA_AW_32(); }

void m68k_op_lea_32_al(void) { AX = EA_AL_32(); }

void m68k_op_lea_32_pcdi(void) { AX = EA_PCDI_32(); }

void m68k_op_lea_32_pcix(void) { AX = EA_PCIX_32(); }
...
void m68k_op_movea_16_d(void) { AX = MAKE_INT_16(DY); }

void m68k_op_movea_16_a(void) { AX = MAKE_INT_16(AY); }

void m68k_op_movea_16_ai(void) { AX = MAKE_INT_16(OPER_AY_AI_16()); }

void m68k_op_movea_16_pi(void) { AX = MAKE_INT_16(OPER_AY_PI_16()); }

void m68k_op_movea_16_pd(void) { AX = MAKE_INT_16(OPER_AY_PD_16()); }

void m68k_op_movea_16_di(void) { AX = MAKE_INT_16(OPER_AY_DI_16()); }

void m68k_op_movea_16_ix(void) { AX = MAKE_INT_16(OPER_AY_IX_16()); }

void m68k_op_movea_16_aw(void) { AX = MAKE_INT_16(OPER_AW_16()); }

void m68k_op_movea_16_al(void) { AX = MAKE_INT_16(OPER_AL_16()); }

void m68k_op_movea_16_pcdi(void) { AX = MAKE_INT_16(OPER_PCDI_16()); }

void m68k_op_movea_16_pcix(void) { AX = MAKE_INT_16(OPER_PCIX_16()); }

void m68k_op_movea_16_i(void) { AX = MAKE_INT_16(OPER_I_16()); }

void m68k_op_movea_32_d(void) { AX = DY; }

void m68k_op_movea_32_a(void) { AX = AY; }

void m68k_op_movea_32_ai(void) { AX = OPER_AY_AI_32(); }

void m68k_op_movea_32_pi(void) { AX = OPER_AY_PI_32(); }

void m68k_op_movea_32_pd(void) { AX = OPER_AY_PD_32(); }

void m68k_op_movea_32_di(void) { AX = OPER_AY_DI_32(); }

void m68k_op_movea_32_ix(void) { AX = OPER_AY_IX_32(); }

void m68k_op_movea_32_aw(void) { AX = OPER_AW_32(); }

void m68k_op_movea_32_al(void) { AX = OPER_AL_32(); }

void m68k_op_movea_32_pcdi(void) { AX = OPER_PCDI_32(); }

void m68k_op_movea_32_pcix(void) { AX = OPER_PCIX_32(); }

void m68k_op_movea_32_i(void) { AX = OPER_I_32(); }
...
void m68k_op_move_16_toc_d(void) { m68ki_set_ccr(DY); }

void m68k_op_move_16_toc_ai(void) { m68ki_set_ccr(OPER_AY_AI_16()); }

void m68k_op_move_16_toc_pi(void) { m68ki_set_ccr(OPER_AY_PI_16()); }

void m68k_op_move_16_toc_pd(void) { m68ki_set_ccr(OPER_AY_PD_16()); }

void m68k_op_move_16_toc_di(void) { m68ki_set_ccr(OPER_AY_DI_16()); }

void m68k_op_move_16_toc_ix(void) { m68ki_set_ccr(OPER_AY_IX_16()); }

void m68k_op_move_16_toc_aw(void) { m68ki_set_ccr(OPER_AW_16()); }

void m68k_op_move_16_toc_al(void) { m68ki_set_ccr(OPER_AL_16()); }

void m68k_op_move_16_toc_pcdi(void) { m68ki_set_ccr(OPER_PCDI_16()); }

void m68k_op_move_16_toc_pcix(void) { m68ki_set_ccr(OPER_PCIX_16()); }

void m68k_op_move_16_toc_i(void) { m68ki_set_ccr(OPER_I_16()); }
...
void m68k_op_movec_32_cr(void) {
    if (CPU_TYPE_IS_010_PLUS(CPU_TYPE)) {
        if (FLAG_S) {
            ...
            m68ki_trace_t0(); /* auto-disable (see m68kcpu.h) */
            switch (word2 & 0xfff) {
                case 0x000: /* SFC */ REG_DA[(word2 >> 12) & 15] = REG_SFC; return;
                case 0x001: /* DFC */ REG_DA[(word2 >> 12) & 15] = REG_DFC; return;
                case 0x002: /* CACR */
                    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
                    ...
                    return;
                case 0x800: /* USP */ REG_DA[(word2 >> 12) & 15] = REG_USP; return;
                case 0x801: /* VBR */ REG_DA[(word2 >> 12) & 15] = REG_VBR; return;
                case 0x802: /* CAAR */
                    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
                ...
                case 0x804: /* ISP */
                    ...
                    m68ki_exception_illegal();
                    return;
                default: m68ki_exception_illegal(); return;
            }
        }
        m68ki_exception_privilege_violation();
        return;
...
void m68k_op_movec_32_rc(void) {
    if (CPU_TYPE_IS_010_PLUS(CPU_TYPE)) {
        if (FLAG_S) {
            ...
            m68ki_trace_t0(); /* auto-disable (see m68kcpu.h) */
            switch (word2 & 0xfff) {
                case 0x000: /* SFC */ REG_SFC = REG_DA[(word2 >> 12) & 15] & 7; return;
                case 0x001: /* DFC */ REG_DFC = REG_DA[(word2 >> 12) & 15] & 7; return;
                case 0x002: /* CACR */
                    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
                    ...
                    m68ki_exception_illegal();
                    return;
                case 0x800: /* USP */ REG_USP = REG_DA[(word2 >> 12) & 15]; return;
                case 0x801: /* VBR */ REG_VBR = REG_DA[(word2 >> 12) & 15]; return;
                case 0x802: /* CAAR */
                    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
    ...
    if (CPU_TYPE_IS_010_PLUS(CPU_TYPE)) {
        if (FLAG_S) {
            ...
            if (BIT_F(word2)) /* Memory to address register */
            {
                ...
                if (CPU_TYPE_IS_020_VARIANT(CPU_TYPE)) USE_CYCLES(2);
                return;
            }
...
void m68k_op_mull_32_d(void) {
    ...
    if (CPU_TYPE_IS_EC020_PLUS(CPU_TYPE)) {
        ...
        if (BIT_B(word2)) /* signed */
        {
            if (GET_MSB_32(src)) src = (uint)MASK_OUT_ABOVE_32(-(sint)src);
            if (GET_MSB_32(dst)) dst = (uint)MASK_OUT_ABOVE_32(-(sint)dst);
        }
