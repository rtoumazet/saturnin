...
//	// logs desactivation
//	#ifdef _LOGS
//	EmuState::pLog->setLogCdBlockOn(false);
//	EmuState::pLog->setLogMemoryOn(false);
//	#endif
//
//	switch(value>>8)
//	{
...
//
//			#ifdef _LOGS
//			EmuState::pLog->CdBlockWrite("-=Get Hardware Info=- executed");
//			#endif
//			break;
//		case 0x2: // Get TOC
...
//
//	if(executedCommands>executedCommandsMax) HIRQREQ &= ~CMOK;
//
//	// logs are reactivated
//	#ifdef _LOGS
//	EmuState::pLog->setLogMemoryOn(true);
//	EmuState::pLog->setLogCdBlockOn(true);
//	#endif
//}
//
//
