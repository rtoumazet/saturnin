...
constexpr Interrupt frt_input_capture_interrupt { 0x64, 0xF };
...
static Interrupt sh2_division_overflow            { 0, 0 };
static Interrupt sh2_dma_0_transfer_end           { 0, 0 };
static Interrupt sh2_dma_1_transfer_end           { 0, 0 };
static Interrupt sh2_wdt_overflow                 { 0, 0 };
static Interrupt sh2_bsc_values_matched           { 0, 0 };
static Interrupt sh2_sci_transmit_end             { 0, 0 };
static Interrupt sh2_sci_receive_error            { 0, 0 };
static Interrupt sh2_sci_receive_data_full        { 0, 0 };
static Interrupt sh2_sci_transmit_data_empty      { 0, 0 };
static Interrupt sh2_frt_input_capture_flag_set   { 0, 0 };
static Interrupt sh2_frt_output_compare_flag_a_set{ 0, 0 };
static Interrupt sh2_frt_output_compare_flag_b_set{ 0, 0 };
static Interrupt sh2_frt_overflow_flag_set        { 0, 0 };
}
