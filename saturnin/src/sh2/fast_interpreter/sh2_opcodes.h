...
void clrmac(Sh2& s, const u32 dummy);
void clrt(Sh2& s, const u32 dummy);
...
void div0u(Sh2& s, const u32 dummy);
...
void nop(Sh2& s, const u32 dummy);
...
void rte(Sh2& s, const u32 dummy);
void rts(Sh2& s, const u32 dummy);
void sett(Sh2& s, const u32 dummy);
...
void sleep(Sh2& s, const u32 dummy);
