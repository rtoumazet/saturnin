...
void Vdp2::write8(const u32 addr, const u8 data) {
    switch (addr & core::vdp2_registers_memory_mask) {
        ...
        case line_scroll_table_address_nbg0_lower + 1: lsta0l_.lower_8_bits = data; break;
        case line_scroll_table_address_nbg1_upper: lsta1u_.upper_8_bits = data; break;
        case line_scroll_table_address_nbg1_upper + 1: lsta1u_.lower_8_bits = data; break;
        case line_scroll_table_address_nbg1_lower: lsta1l_.upper_8_bits = data; break;
        case line_scroll_table_address_nbg1_lower + 1: lsta1l_.lower_8_bits = data; break;
        case line_color_screen_table_address_upper: lctau_.upper_8_bits = data; break;
        case line_color_screen_table_address_upper + 1: lctau_.lower_8_bits = data; break;
        case line_color_screen_table_address_lower: lctal_.upper_8_bits = data; break;
        case line_color_screen_table_address_lower + 1: lctal_.lower_8_bits = data; break;
        ...
        case screen_over_pattern_name_a + 1: ovpnra_.lower_8_bits = data; break;
        case screen_over_pattern_name_b: ovpnrb_.upper_8_bits = data; break;
        case screen_over_pattern_name_b + 1: ovpnrb_.lower_8_bits = data; break;
        case rotation_parameter_table_address_upper: rptau_.upper_8_bits = data; break;
        case rotation_parameter_table_address_upper + 1: rptau_.lower_8_bits = data; break;
        case rotation_parameter_table_address_lower: rptal_.upper_8_bits = data; break;
        case rotation_parameter_table_address_lower + 1: rptal_.lower_8_bits = data; break;
        case window_position_w0_h_start_point: wpsx0_.upper_8_bits = data; break;
        case window_position_w0_h_start_point + 1: wpsx0_.lower_8_bits = data; break;
        case window_position_w0_v_start_point: wpsy0_.upper_8_bits = data; break;
        case window_position_w0_v_start_point + 1: wpsy0_.lower_8_bits = data; break;
        case window_position_w0_h_end_point: wpex0_.upper_8_bits = data; break;
        case window_position_w0_h_end_point + 1: wpex0_.lower_8_bits = data; break;
        case window_position_w0_v_end_point: wpey0_.upper_8_bits = data; break;
        case window_position_w0_v_end_point + 1: wpey0_.lower_8_bits = data; break;
        case window_position_w1_h_start_point: wpsx1_.upper_8_bits = data; break;
        case window_position_w1_h_start_point + 1: wpsx1_.lower_8_bits = data; break;
        case window_position_w1_v_start_point: wpsy1_.upper_8_bits = data; break;
        case window_position_w1_v_start_point + 1: wpsy1_.lower_8_bits = data; break;
        case window_position_w1_h_end_point: wpex1_.upper_8_bits = data; break;
        case window_position_w1_h_end_point + 1: wpex1_.lower_8_bits = data; break;
        case window_position_w1_v_end_point: wpey1_.upper_8_bits = data; break;
        case window_position_w1_v_end_point + 1: wpey1_.lower_8_bits = data; break;
